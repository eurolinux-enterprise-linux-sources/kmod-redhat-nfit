%define kmod_name		nfit
%define kmod_vendor		redhat
%define kmod_driver_version	3.10.0_957
...
%define kmod_kbuild_dir		drivers/acpi/nfit
%define kmod_dependencies       %{nil}
%define kmod_dist_build_deps	%{nil}
%define kmod_build_dependencies	%{nil}
%define kmod_devel_package	0
%define kmod_install_path	extra/kmod-redhat-nfit
...
# Source code patches
Patch0:	_RHEL7.6_PATCH_1-2_acpi-nfit_Block_function_zero_DSMs.patch
Patch1:	_RHEL7.6_PATCH_2-2_acpi-nfit_Fix_command-supported_detection.patch
Patch2:	0003-bump-version.patch
...
Name:		kmod-redhat-nfit
Version:	%{kmod_driver_version}
Release:	%{kmod_rpm_release}%{?dist}
%if "%{kmod_driver_epoch}" != ""
Epoch:		%{kmod_driver_epoch}
%endif
Summary:	nfit kernel module for Driver Update Program
Group:		System/Kernel
License:	GPLv2
...
%description
nfit kernel module for Driver Update Program

%if 0

%package -n kmod-redhat-nfit-firmware
Version:	ENTER_FIRMWARE_VERSION
Summary:	nfit firmware for Driver Update Program
...
Provides:	kernel-modules = %{kmod_kernel_version_dep}.%{_target_cpu}
%endif
%description -n  kmod-redhat-nfit-firmware
nfit firmware for Driver Update Program


%files -n kmod-redhat-nfit-firmware
...
%package -n kmod-redhat-nfit-devel
Version:	%{kmod_driver_version}
Requires:	kernel >= 3.10.0-957.el7
Requires:	kernel < 3.10.0-958.el7
Summary:	nfit development files for Driver Update Program

%description -n  kmod-redhat-nfit-devel
nfit development files for Driver Update Program


%files -n kmod-redhat-nfit-devel
%defattr(644,root,root,755)
...
rpm -ql kmod-redhat-nfit-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
...
%changelog
* Mon Feb 11 2019 Eugene Syromiatnikov <esyr@redhat.com> 3.10.0_957-1
